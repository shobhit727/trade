...
pub fn bollinger_bands(prices: &[f64], period: usize, std_mult: f64) -> (Vec<f64>, Vec<f64>, Vec<f64>) {
...
mod tests {
    ...
    #[test]
    fn test_rsi() {
        let prices = vec![100.0, 101.0, 100.5, 102.0, 101.5, 103.0, 102.5, 104.0, 103.5, 105.0];
