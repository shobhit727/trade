"""Tests for catalog strategy adx_trend."""

from __future__ import annotations

from cryptobot.strategies.catalog.adx_trend import AdxTrendStrategy
...
def test_adx_trend_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_adx_trend_short_signal():
