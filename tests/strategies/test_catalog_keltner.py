"""Tests for catalog strategy keltner."""

from __future__ import annotations

import math

from cryptobot.strategies.catalog.keltner import KeltnerStrategy
...
def test_keltner_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_keltner_short_signal():
