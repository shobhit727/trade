"""Tests for catalog strategy squeeze."""

from __future__ import annotations

from cryptobot.strategies.catalog.squeeze import SqueezeStrategy
...
def test_squeeze_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_squeeze_short_signal():
