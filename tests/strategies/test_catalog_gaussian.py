"""Tests for catalog strategy gaussian."""

from __future__ import annotations

import math

from cryptobot.strategies.catalog.gaussian import GaussianStrategy
...
def test_gaussian_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_gaussian_short_signal():
