"""Tests for catalog strategy corr_gate."""

from __future__ import annotations

from cryptobot.strategies.catalog.corr_gate import CorrGateStrategy
...
def test_corr_gate_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_corr_gate_short_signal():
