"""Tests for catalog strategy macd_momentum."""

from __future__ import annotations

from cryptobot.strategies.catalog.macd_momentum import MacdMomentumStrategy
...
def test_macd_momentum_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_macd_momentum_short_signal():
