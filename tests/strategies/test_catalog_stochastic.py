"""Tests for catalog strategy stochastic."""

from __future__ import annotations

import math

from cryptobot.strategies.catalog.stochastic import StochasticStrategy
...
def test_stochastic_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_stochastic_short_signal():
