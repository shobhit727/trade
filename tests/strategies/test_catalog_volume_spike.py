"""Tests for catalog strategy volume_spike."""

from __future__ import annotations

from cryptobot.strategies.catalog.volume_spike import VolumeSpikeStrategy


def test_volume_spike_expansion_follows_spike():
