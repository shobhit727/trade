"""Tests for catalog strategy donchian."""

from __future__ import annotations

from cryptobot.strategies.catalog.donchian import DonchianStrategy
...
def test_donchian_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_donchian_short_signal():
