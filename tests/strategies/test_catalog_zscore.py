"""Tests for catalog strategy zscore."""

from __future__ import annotations

import math

from cryptobot.strategies.catalog.zscore import ZscoreStrategy
...
def test_zscore_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_zscore_short_signal():
