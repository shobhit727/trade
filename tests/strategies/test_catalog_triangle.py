"""Tests for catalog strategy triangle."""

from __future__ import annotations

from cryptobot.strategies.catalog.triangle import TriangleStrategy
...
def test_triangle_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_triangle_short_signal():
