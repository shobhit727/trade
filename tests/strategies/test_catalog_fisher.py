"""Tests for catalog strategy fisher."""

from __future__ import annotations

import math

from cryptobot.strategies.catalog.fisher import FisherStrategy
...
def test_fisher_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_fisher_short_signal():
