"""Tests for catalog strategy volume_profile."""

from __future__ import annotations

from cryptobot.strategies.catalog.volume_profile import VolumeProfileStrategy
...
def test_volume_profile_flow_long_signal():
    assert any(o.side.value == "BUY" for o in _flow(True))


def test_volume_profile_flow_short_signal():
