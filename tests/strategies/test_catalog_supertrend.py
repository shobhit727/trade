"""Tests for catalog strategy supertrend."""

from __future__ import annotations

from cryptobot.strategies.catalog.supertrend import SupertrendStrategy
...
def test_supertrend_long_signal():
    assert any(o.side.value == "BUY" for o in _series(True))


def test_supertrend_short_signal():
