"""Tests for catalog strategy cumulative_delta."""

from __future__ import annotations

from cryptobot.strategies.catalog.cumulative_delta import CumulativeDeltaStrategy
...
def test_cumulative_delta_flow_long_signal():
    assert any(o.side.value == "BUY" for o in _flow(True))


def test_cumulative_delta_flow_short_signal():
